...
group = "com.xbaimiao.logger"

version = "1.0.0"

easylib {
    env {
        mainClassName = "com.xbaimiao.logger.EasyLogger"
        pluginName = "EasyLogger"
...
//    }
    ...
    library("ch.qos.logback:logback-classic:1.4.14",false)
    library("de.siegmar:logback-gelf:6.1.0",false)
